...
#[derive(Debug)]
pub struct HyperCyberProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperCyberProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperCyber processing");
    
    let mut processor = HyperCyberProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperCyberProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperCyberProcessor::new(false);
